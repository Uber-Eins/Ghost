...
const Select = ({ value, defaultValue, ...props }: SelectProps) => {
  ...
  return <SelectPrimitive.Root key={selectedValue} defaultValue={selectedValue} {...props} />;
};
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-32 overflow-hidden rounded-xl border border-border bg-popover text-popover-foreground shadow-xl",
