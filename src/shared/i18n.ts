const MESSAGES = {
  en: {
    ...
    earlyBootstrapUnavailable: "Enable Allow User Scripts for protection before page scripts run",
    ...
    globalConfigSubtitle: "Global protection, UA behavior, and advanced override settings.",
  ...
  "zh-CN": {
    ...
    edit: "编辑",
    editProfile: "编辑画像",
    earlyBootstrapUnavailable: "请启用“允许用户脚本”，以便在页面脚本运行前完成保护",
    ...
    globalConfig: "全局配置",
    globalConfigSubtitle: "全局保护、UA 行为与高级覆盖设置。",
